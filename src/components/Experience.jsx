const jobs = [
  {
    period: '2025 – Present',
    role: 'Batch Scheduler & Automation Engineer',
    ...
    points: [
      ...
      'Developed specialized Chat Bot tools to assist in job scheduling and automation tasks, enhancing operational efficiency.',
      'Innovated a workflow using Power Automate for Abend alerts along with recovery action and automated batch tracker to enhance monitoring.'
    ],
  },
  {
    period: '2024 – 2025',
  ...
  },
  {
    ...
    company: 'Tata Consultancy Services · Agent Developer',
    dotColor: 'var(--accent)',
    dotShadow: '0 0 12px var(--accent)',
    points: [
      'Automating Incident handling through multi Agent concept using Google ADK 2.0'
    ],
  },
]
