const projects = [
  {
    ...
    tags: ['Python', 'IWS Tool', 'ESP Tool', 'TCS'],
  },
  {
    icon: '🪫',
    iconBg: 'rgba(108,99,255,0.12)',
    iconBorder: 'rgba(108,99,255,0.2)',
    title: 'Power Automate Workflow for Abend Alerts & Tracker',
    desc: 'Automated workflow using Power Automate to monitor Abend alerts, trigger recovery actions, and maintain a batch tracker for enhanced operational oversight.',
    tags: ['Power Automate', 'Workflow', 'Analysis', 'TCS'],
  ...
  },
  {
    ...
    desc: 'Developed backend applications using Django, including an Event Booking System and an Issue Tracking System.',
  ...
  },
  {
    ...
    title: 'Multi-Agent Development - Coming Soon',
    desc: 'Developing a Multi-Agent system integrating differnt tools, agents, and  python functions using a graph based workflows.',
